...
class SLF_function_gui:
    def __init__(self, project_name, component_data, correlation_tree, edp_bin=None,
    ...
    def get_component_data(self):
        ...
        # Check if grouping of components was assigned
        # TODO, add grouping by user option, if not assigned, do automatic performance grouping - current Group feature is unused
...
if __name__ == "__main__":
    ...
    """
    slf = SLF_function_gui("Correlated", "component_data2.csv", "correlation_tree2.csv", correlation="Correlated", n_realizations=20,
    ...
    if run_master:
        ...
        for group in component_groups:
            if not component_groups[group].empty:
                ...
                loss_ratios, total_loss_storey, total_loss_ratio, total_loss, repair_cost = slf.calculate_loss(
                    component_data,
                    damage_state,
